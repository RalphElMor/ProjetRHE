    ...
    <body>
        <div id="global">
            <header>
                ...
                <a href=""><h1 id="titreBlog"><span data-i18n="BlogueProf">Piece Auto Performance</span> v1.0.0.1</h1></a>
                <p>Version avec démarrage de session pour accès aux opérations de gestion</p>
                <a href="<?= $utilisateur != null ? 'Admin' : ''; ?>">
                    <h4>Afficher toutes les pieces</h4>
                </a>
                <a href="Apropos">
                    <h4>À propos</h4>
                </a>
